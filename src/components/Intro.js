...
export default function Intro() {
  return (
    <div className="intro">
      <p className="marathon-logo">
        Авторский марафон любви к себе от девушки, которая прошла этот путь
        полностью 🕊
      </p>
      ...
      <div className="if-you-container">
        ...
        <div className="types-section">
          <span className="type">
            Понимаешь, что твоя самооценка нестабильна
          </span>
          <span className="type">
            Не любишь смотреть в зеркало, избегаешь собственного отражения в нем
          </span>
          <span className="type">
            Сложно сходишься с людьми, испытываешь затруднения в общении
          </span>
          <span className="type">Чувствуешь себя одинокой</span>
          <span className="type">
            Хочешь безопасно пройти путь к новой себе
          </span>
        </div>
      </div>
      <div className="its-for-you-text">
        <span>
          <b>Тогда мой курс именно для ТЕБЯ!</b>
        </span>
