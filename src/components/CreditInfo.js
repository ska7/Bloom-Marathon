...
export default function CreditInfo() {
    ...
    return (
        <div className='credit-info-section'>
            ...
            <h2>Скопируй номер карты и оплати любым удобным для тебя способом. Для Сбербанка выбери "Перевод за рубеж". После оплаты, скинь мне скриншот в личные сообщения @dia.bloom</h2>
            <div className="credit-card">
                <div className={blink && 'blink'}></div>
                <p>5168&nbsp;&nbsp;&nbsp;7555&nbsp;&nbsp;&nbsp;3171&nbsp;&nbsp;&nbsp;9785</p>
              ...
              <div className='ig-page-link'>
                ...
                <h2><a style={{ color: 'black' }} href="https://www.instagram.com/dia.bloom/"><img src={icon}></img>dia.bloom</a></h2>
              </div>  
        </div>
    )
}
